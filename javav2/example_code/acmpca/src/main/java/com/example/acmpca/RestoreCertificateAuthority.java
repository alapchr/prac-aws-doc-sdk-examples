...
public class RestoreCertificateAuthority {
  ...
  public static void main(String[] args) throws Exception {
    ...
    RestoreCertificateAuthorityRequest req =
        RestoreCertificateAuthorityRequest.builder().certificateAuthorityArn(caArn).build();
    ...
    try {
      ...
      System.out.println("ERROR: Invalid ARN format: " + e.getMessage());
    } catch (InvalidStateException e) {
      System.out.println("ERROR: Invalid CA state: " + e.getMessage());
    } catch (ResourceNotFoundException e) {
      System.out.println("ERROR: CA not found " + e.getMessage());
